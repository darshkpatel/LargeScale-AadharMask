...
def text_mask(img, east="frozen_east_text_detection.pb", min_confidence=0.5, width=320, height=320):
...
#nms.felzenszwalb.nms, nms.fast.nms,
    ...
    for i, function in enumerate(functions):
        ...
        retval, buffer = cv2.imencode('.jpg', drawOn)
    ...
    #     cv2.imwrite("./masked1.jpg",drawOn)
